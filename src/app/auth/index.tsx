...
import { View, Text, TextInput, TouchableOpacity, Image, Alert, ActivityIndicator, Dimensions, useWindowDimensions, KeyboardAvoidingView, ScrollView, Platform } from "react-native";
        ...
        >
            ...
            <View className="w-full max-w-sm">
                ...
                <View>
                    ...
                    className="w-full border border-gray-200 rounded-2xl p-4 bg-gray-50 text-lg text-gray-900"
                    value={email}
