...
export default function EditMenuScreen() {
        ...
        const loadData = async () => {
            try {
                ...
                if (product.product_ingredients) {
                    const mappedRecipe: RecipeItem[] = product.product_ingredients.map(pi => ({
                        ingredient_id: pi.ingredient_id,
                        quantity: pi.quantity.toString(),
                        ingredientName: pi.ingredients?.name || 'Unknown',
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Upload Image if it's changed and local
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <View className="bg-white pt-12 pb-4 px-6 shadow-sm z-10 flex-row items-center justify-between">
                ...
                <Text className="text-xl font-bold text-gray-900">Edit Data Menu</Text>
                <TouchableOpacity onPress={handleDelete} className="p-2 bg-red-50 rounded-lg">
                    ...
                    {submitting ? (
                        ...
                        <>
                            ...
                            <Text className="text-white font-bold text-base">
                                {uploadingImage ? "Uploading Image..." : "Update Data"}
                            </Text>
                        </>
                    )}
                </TouchableOpacity>
