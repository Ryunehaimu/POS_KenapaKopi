...
export const PaymentModal = ({ visible, onClose, subtotal, onConfirm, loading }: PaymentModalProps) => {
  ...
  // Calculations
  const rawDiscountValue = discountType === 'percent' ? parseFloat(discountValue || '0') : parseRupiah(discountValue);
  ...
  const cashReceivedNum = parseRupiah(cashReceived);
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) => {
                        if (discountType === 'percent') {
                          ...
                          setDiscountValue(formatRupiah(numeric, 'Rp '));
                        }
                      }}
              ...
              {paymentMethod === 'cash' ? (
                <View className="mb-3">
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) => {
                      const numeric = text.replace(/[^0-9]/g, '');
                      const formatted = formatRupiah(numeric, 'Rp ');
                      console.log(`Input: ${text}, Numeric: ${numeric}, Formatted: ${formatted}`);
